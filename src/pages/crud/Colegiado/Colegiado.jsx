                            ...
                            <table className=" space-y-2 w-full mb-5">
                                <thead>
                                    <tr className="text-nowrap shadow-2xl sticky top-0 bg-[#a3273e] text-gray-100 text-sm ">
                                        ...
                                        <th className="border-e-1 p-2 border-gray-300">Nacionalidad</th>
                                        <th>Acciones</th>
                                    </tr>
                                </thead>
                                <tbody className="">
                                        ...
                                        <tr key={datos.id} className="hover:bg-[#bb2b46]/60 hover:text-white even:bg-[#bb2b46]/8  mt-2 cursor-pointer transition-all shrink-0 overflow-x-scroll">
                                            ...
                                            <td className="py-1.5 px-4">
                                                <div className="action-boton grid grid-cols-3 gap-2">
                                                    ...
                                                    <Link to={`/colegiados/${datos.id}/editar`} className="flex justify-center items-center bg-orange-300 text-orange-600 hover:bg-orange-600 hover:text-orange-300 cursor-pointer font-medium py-1 text-sm rounded-full">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">

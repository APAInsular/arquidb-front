                ...
                <div className="text-center">
                    <table className="table-fixed w-full mb-5">
                        ...
                        <tbody>
                            <tr>
                                <td>Pedro</td>
                                <td>pedrops@gmail.com</td>
                                <td>Visador</td>
                                <td>50</td>
                                <td>
                                    <Link to="/usuarios/1" className="bg-red-700 text-white py-1 px-6 rounded-lg">Ver</Link>
                                </td>
                                <td>
                    ...
                    <Link to="/usuarios/crear" className="text-center flex justify-center">

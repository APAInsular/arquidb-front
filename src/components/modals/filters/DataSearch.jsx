    ...
    return (
        <div className={`absolute z-20 top-10 left-0 w-full bg-[#a81d37] text-white/70 pt-3  rounded-b-xl mt-2 shadow-2xl space-y-3`}>
            ...
            {datos.length >= 1 && query ?
                <Link to={`/?search=${query}`} className="my-2 cursor-pointer py-2 px-2 flex space-x-4 flex-row hover:bg-red-900" >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        <path fillRule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clipRule="evenodd" />
                    </svg>
                    <p>
                        <strong>ENTER</strong> para ver todos los resultados de busqueda de "{query}"
                    </p>
                </Link>
                : ""}
